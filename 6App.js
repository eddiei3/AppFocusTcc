		...
		return (
			...
			<ScrollView contentContainerStyle={{flexGrow: 1}}>
				<View style={styles.getStartedContainer}>
					{image ? null : (
						<Text style={[styles.getStartedText, { top: 50}]}> Focus</Text>
					)}
				</View>
				...
				<TouchableOpacity style={[styles.button, { left: 150,  top: 300 }]} onPress={this._pickImage}>
					<FontAwesome name="upload" size={23} color="#000" />
				</TouchableOpacity>

				<TouchableOpacity style={[styles.button, { left: 100, top: 200 }]} onPress={() => { this.setModalVisible(true) }}>
